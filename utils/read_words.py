...
class ReadWords(object):
    def __init__(self):
        path = os.path.join(projectdir, 'processed_question')
        self.all_file = []
        ...
        with open(os.path.join(projectdir, "txt_file/contents.txt"), "w", encoding="utf-8") as f:
            for content in self.contents:
                f.write("\n".join(content) + "\n")
        with open(os.path.join(projectdir, "txt_file/questions.txt"), "w", encoding="utf-8") as f:
