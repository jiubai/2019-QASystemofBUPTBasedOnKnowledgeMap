...
def trans_question(texts):
    questions_dict = json.load(
        open(os.path.join(projectdir, "txt_file/questions_dict.json"), 'r', encoding='utf-8'))
    ...
    for text in texts:
        ...
        with open(os.path.join(projectdir, "txt_file/questions_dict.json"), 'w', encoding='utf-8') as f:
