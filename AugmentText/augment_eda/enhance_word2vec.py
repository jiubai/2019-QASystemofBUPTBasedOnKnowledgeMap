from utils.text_tools import jieba_cut, load_word2vec_model
...
def main():
    with open("E:\\QABasedOnKnowledgeMap\\2019-QASystemofBUPTBasedOnKnowledgeMap\\txt_file\\questions.txt", 'r',
              encoding="utf-8") as f:
        data = f.read().splitlines()
    data = [d.strip() for d in data]
    sys_data = get_syn_sentences(data)
    print(sys_data)
